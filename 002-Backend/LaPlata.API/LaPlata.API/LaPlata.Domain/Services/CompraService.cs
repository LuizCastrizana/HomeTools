...
namespace LaPlata.Domain.Services
{
    public class CompraService : ICompraService
    {
        ...
        public CompraService(IContext<Compra> context, IContext<Cartao> contextCartao, IContext<LogErro> contextLogErro, IMapper mapper)
        {
            _context = context;
        ...
        public RespostaServico<ReadCompraDTO> IncluirCompra(CreateCompraDTO DTO)
        {
            try
            {
                ...
                {
                    retorno.Mensagem = "Cartão não encontrado.";
